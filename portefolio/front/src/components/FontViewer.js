        ...
        <div className="font-viewer__flex-wrapper--top">
          <div className="font-viewer__left" style={{ minWidth: leftWidthScale(screenWidth) }}>
            ...
            <div className="font-viewer__weight-area">
              {
                !detailSelected ? 
                <a href="#" style={{ opacity: hovered ? 0.5 : 1 }} onMouseEnter={this.handleMouseEnter.bind(this)} onMouseLeave={this.handleMouseLeave.bind(this)} onClick={this.handleDetailSelectedClick.bind(this)}>
