        ...
        <header className="header-collapsed" style={{ top: headerCollapsedTop }} ref={ ref => { this.refHeader = ref; }}>
        {
          ...
          <div className="header-collapsed__flexwrap">
            <div className="header-collapsed__left">
              <a href="#" onClick={this.handleMoveTop.bind(this)}>
                <h1>
              ...
              }
              {
                ...
                <div className="header-collapsed__categories">
                  <a className="category-selector--selected" href="#" onClick={ this.handleCategoryClick.bind(this) }>
                    {
                      locale == "ko" ?
                      <Fragment>
            ...
            }
            {
              ...
              <div className="header__description-area">
                <div className={`header__menu--${locale}`}>
                  <a href="#" className="" onClick={this.moveToDescription.bind(this)}>
                    <span className="en-black">Google Fonts + </span> 한국어 소개 
                  </a>
                  <a href="#" onClick={this.handleToggleLocale.bind(this)} className="en-black">
                    English
                  </a>
                </div>
              </div> : 
              <div className="header__description-area">
                <div className={`header__menu--${locale}`}>
                  <a href="#"  onClick={this.moveToDescription.bind(this)}>
                    About Google Fonts + Korean
                  </a>
                  <a href="#" onClick={this.handleToggleLocale.bind(this)} className="">
                    한국어
                  </a> 
                </div>
              </div>) : null
            ...
            <a href="#" onClick={this.toggleMenu.bind(this)} className="header-collapsed__hamburger">
              {
                this.state.isMenuOpen ? 
                <img src={`/assets/close_${backgroundMode}.svg`} alt="menu" /> :
                <img src={`/assets/hamburger_${backgroundMode}.svg`} alt="menu" />
              }
            </a>
          </div>
          {
            ...
            <Fragment>
                ...
                <div className="header__categories">
                  {
                    _.map(CATEGORIES, categoryData => {
                      return (
                        <a className={`category-selector${ categoryData.id === currentCategory ? "--selected" : ""}`} onClick={this.handleCurrentCategory.bind(this, categoryData)} key={categoryData.id} href="#">
                          {
                            locale == "ko" ? 
                            <Fragment>
              ...
              <div className={`header__menu--${locale}`}>
                <div>
                  <a href="#" className="en-black" onClick={this.moveToDescription.bind(this)}>
                    About Google Fonts + Korean
                  </a>
                  <a href="#" onClick={this.handleToggleLocale.bind(this)} className="">
                    한국어
