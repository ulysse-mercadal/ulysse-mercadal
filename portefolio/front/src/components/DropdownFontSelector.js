  ...
  render() {
    ...
    return (
      <div className="dropdown-font-selector">
        <a href="#" onClick={this.handleDropdownClick.bind(this)} className="dropdown-font-selector__selected">
          {
            locale == "ko" ? 
            <Fragment>
              ...
              <div style={{ marginTop: -2 }}><img src={`/assets/arrow_down_${backgroundMode}.svg`} alt="arrow_down" /></div>
            </Fragment> :
            <Fragment>
...
//<div style={{ marginTop: screenWidth > BODY_600 ? -6 : 0 }}><img src={`/assets/arrow_down_${backgroundMode}.svg`} alt="arrow_down" /></div>