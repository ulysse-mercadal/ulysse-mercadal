    ...
    return (
      <Fragment>
        <div className="font-viewer__detail-left" style={{ minWidth: leftWidthScale(screenWidth) }}>
          <a href="#" onClick={this.props.handleClosed} className="close">
            <img src={`/assets/close_detail_${backgroundMode}.svg`} alt="arrow_close" />
          </a>
              ...
              <div className="font-viewer__detail-content">
                {
                  _.map(this.props.weights, weightData => {
                    ...
                    return (
                      <a className={`font-viewer__weight-link${ selected ? "--selected" : ""}`} href="#" key={weightData.fontWeight} onClick={this.handleWeightToggle.bind(this, weightData)}>
