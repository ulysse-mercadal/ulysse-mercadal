...
\begin{tikzpicture}[remember picture,overlay]
        ...
        at ([xshift=0.36\paperwidth, yshift=-0.345\paperwidth]current page.north west)
    {
        ...
        \textit{Ezyperf} \hfill \textit{Full Remote, France / Japon}\\[0.1cm]
        ...
        \textit{Groupe IONIS} \hfill \textit{Lyon, France}\\[0.1cm]
        ...
        \blackchip{R-TYPE} \hfill \textit{C++, OpenGL, Protocole Réseau, Asio, ECS}\\[0.12cm]
