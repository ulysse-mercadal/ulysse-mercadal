...
\begin{tikzpicture}[remember picture,overlay]
        ...
        at ([xshift=0.16666\paperwidth, yshift=-0.34\paperwidth]current page.north west)
    {
        ...
        % Technical Skills
        {\Large \textbf{TECHNICAL SKILLS}}\\[0.35cm]
        \hrule width \linewidth height 1pt \vspace{12pt}
        ...
        % Gap Year
        {\Large \textbf{GAP YEAR}}\\[0.35cm]
        \hrule width \linewidth height 1pt \vspace{0.35cm}
        \textbf{In progress}\\[0.25cm]
        \chip{ICLP $|$ National Taiwan University}\\[0.25cm]
        {\small Intensive Chinese Language Program (Taipei)}

        \vspace{1.3cm}

        % Soft Skills
        {\Large \textbf{SOFT SKILLS}}\\[0.35cm]
        \hrule width \linewidth height 1pt \vspace{0.35cm}
        \centering
        ...
        % Languages
        {\Large \textbf{LANGUAGES}}\\[0.35cm]
        \hrule width \linewidth height 1pt \vspace{0.35cm}
        French: \chip{Native}\\[0.3cm]
        English: \chip{Fluent}\\[0.3cm]
        Spanish: \chip{Advanced}\\[0.3cm]
        Chinese: \chip{Learning / ICLP}\\[0.4cm]
    };
