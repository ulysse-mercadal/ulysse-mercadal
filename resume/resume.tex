...
\begin{tikzpicture}[remember picture,overlay]
        ...
        at ([xshift=0.36\paperwidth, yshift=-0.345\paperwidth]current page.north west)
    {
        ...
        \href{https://ezyperf.com/}{\textit{Ezyperf}} \hfill \textit{Full Remote, France / Japan}\\[0.1cm]
        ...
        \href{https://www.ionis-group.com/}{\textit{IONIS Education Group}} \hfill \textit{Lyon, France}\\[0.1cm]
        ...
        \blackchiphref{https://github.com/nicolasnny/R-TYPE}{R-TYPE} \hfill \textit{C++, OpenGL, Network Protocol, Asio, ECS}\\[0.12cm]
